...
public class DebugUIBuilder : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        if (!lp)
        {
            UnityEngine.Debug.LogError("Debug UI requires use of a LaserPointer and will not function without it. " +
    ...
    private void PanelCentricRelayout()
    {
        if (!isHorizontal)
        {
            UnityEngine.Debug.Log("Error:Panel Centeric relayout is implemented only for horizontal panels");
            return;
        }
    ...
    private void AddRect(RectTransform r, int targetCanvas)
    {
        ...
        {
            UnityEngine.Debug.LogError("Attempted to add debug panel to canvas " + targetCanvas + ", but only " +
