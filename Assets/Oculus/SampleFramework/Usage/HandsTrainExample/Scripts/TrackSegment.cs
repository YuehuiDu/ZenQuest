    ...
    public class TrackSegment : MonoBehaviour
    {
        ...
        private void DrawDebugLines()
        {
            for (int i = 1; i < SubDivCount + 1; i++)
            {
                ...
                UnityEngine.Debug.DrawLine(_p1.Position + halfTrackWidth * (_p1.Rotation * Vector3.right),
            ...
            // bottom bound
            UnityEngine.Debug.DrawLine(transform.position - 0.5f * GridSize * transform.right,
            ...
            UnityEngine.Debug.DrawLine(transform.position + 0.5f * GridSize * transform.right,
                transform.position + 0.5f * GridSize * transform.right + GridSize * transform.forward, Color.yellow);
            // top bound
            UnityEngine.Debug.DrawLine(transform.position - 0.5f * GridSize * transform.right + GridSize * transform.forward,
